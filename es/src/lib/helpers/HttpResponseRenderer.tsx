...
class HttpResponseRendererConfig<T> {
    public readonly ifResponseIsNull:(response:HttpResponse<T>) => JSX.Element | JSX.Element[];
    public readonly initial:(response:HttpResponse<T>) => JSX.Element | JSX.Element[];
    public readonly loading:(response:HttpResponse<T>) => JSX.Element | JSX.Element[];
    public readonly success:(response:HttpResponse<T>) => JSX.Element | JSX.Element[];
    public readonly error:(response:HttpResponse<T>) => JSX.Element | JSX.Element[];
}

export class HttpResponseRenderer<T> {

    public readonly ifResponseIsNull:(response:HttpResponse<T>) => JSX.Element | JSX.Element[];
    private readonly initial:(response:HttpResponse<T>) => JSX.Element | JSX.Element[];
    private readonly loading:(response:HttpResponse<T>) => JSX.Element | JSX.Element[];
    private readonly success:(response:HttpResponse<T>) => JSX.Element | JSX.Element[];
    private readonly error:(response:HttpResponse<T>) => JSX.Element | JSX.Element[];
